...
export function getProductCopy(locale: LocaleCode): { common: { close: string; configuration: string; connectToAi: string; executiveEducation: string; registration: string; map: string; menu: string; news: string; no: string; project: string; search: string; yes: string; }; home: { introEyebrow: string; introTitle: string; introBody: string; newsEyebrow: string; newsTitle: string; newsBody: string; cards: { action: string; body: string; href: string; title: string; }[]; }; siteHeader: { mobileMenuLabel: string; officialLinksLabel: string; searchLabel: string; secondaryNav: { configuration: string; connectToAi: string; executiveEducation: string; registration: string; project: string; }; }; plannerWizard: { academicLevelBody: string; academicLevelOptions: { graduate: { body: string; title: string; }; jointPrograms: { body: string; title: string; }; undergraduate: { body: string; title: string; }; }; academicLevelTitle: string; careerBody: string; careerLimit: string; careerNone: string; careerSearch: string; careerTitle: string; classesBody: string; classesCount: string; classesTitle: string; localeBody: string; localeTitle: string; jointProgramsBody: string; jointProgramsEmpty: string; jointProgramsTitle: string; subjectsBody: string; subjectsCount: string; subjectsDefaultEmpty: string; subjectsRecommendedApplied: string; subjectsRecommended: string; subjectsSearchPlaceholder: string; subjectsSelected: string; subjectsTitle: string; selectedCount: string; stepLabels: { academicLevel: string; careers: string; classes: string; entryTerm: string; finish: string; intro: string; jointPrograms: string; locale: string; subjects: string; swipe: string; }; validation: { academicLevel: string; careers: string; classes: string; jointPrograms: string; jointProgramsRequired: string; locale: string; subjects: string; }; }; plannerSettings: { eyebrow: string; classSpacingBody: string; classSpacingOptions: { clustered: string; separated: string; }; classSpacingTitle: string; importanceLabel: string; lighterDayBody: string; lighterDayTitle: string; noPreference: string; preferencesBody: string; preferencesTitle: string; resetBody: string; resetButton: string; resetConfirm: string; availableSubjectBadge: string; scheduleBody: string; scheduleEmpty: string; scheduleLoadError: string; scheduleLoading: string; scheduleTitle: string; selectedClassesEmpty: string; selectedClassesTitle: string; selectedSubjectBadge: string; sameTheoryLabGroupBody: string; sameTheoryLabGroupTitle: string; subjectsBody: string; subjectsDefaultTitle: string; subjectsEmpty: string; subjectsSelectedTitle: string; subjectsSearch: string; subjectsTitle: string; swipeBody: string; swipeTitle: string; teacherRankingBody: string; teacherRankingTitle: string; timeRangeBody: string; timeRangeEndLabel: string; timeRangeStartLabel: string; timeRangeTitle: string; title: string; }; plannerPage: { filteredSubjectsBody: string; filteredSubjectsEmpty: string; filteredSubjectsTitle: string; quickActionsTitle: string; }; searchPage: { empty: string; eyebrow: string; inputLabel: string; inputPlaceholder: string; title: string; }; registrationPage: { body: string; sourceLabels: { destination: string; services: string; }; steps: string[]; title: string; traceability: string; }; mapPage: { body: string; title: string; }; } | { common: { close: string; configuration: string; connectToAi: string; executiveEducation: string; registration: string; map: string; menu: string; news: string; no: string; project: string; search: string; yes: string; }; home: { introEyebrow: string; introTitle: string; introBody: string; newsEyebrow: string; newsTitle: string; newsBody: string; cards: { action: string; body: string; href: string; title: string; }[]; }; siteHeader: { mobileMenuLabel: string; officialLinksLabel: string; searchLabel: string; secondaryNav: { configuration: string; connectToAi: string; executiveEducation: string; registration: string; project: string; }; }; plannerWizard: { academicLevelBody: string; academicLevelOptions: { graduate: { body: string; title: string; }; jointPrograms: { body: string; title: string; }; undergraduate: { body: string; title: string; }; }; academicLevelTitle: string; careerBody: string; careerLimit: string; careerNone: string; careerSearch: string; careerTitle: string; classesBody: string; classesCount: string; classesTitle: string; localeBody: string; localeTitle: string; jointProgramsBody: string; jointProgramsEmpty: string; jointProgramsTitle: string; subjectsBody: string; subjectsCount: string; subjectsDefaultEmpty: string; subjectsRecommendedApplied: string; subjectsRecommended: string; subjectsSearchPlaceholder: string; subjectsSelected: string; subjectsTitle: string; selectedCount: string; stepLabels: { academicLevel: string; careers: string; classes: string; entryTerm: string; finish: string; intro: string; jointPrograms: string; locale: string; subjects: string; swipe: string; }; validation: { academicLevel: string; careers: string; classes: string; jointPrograms: string; jointProgramsRequired: string; locale: string; subjects: string; }; }; plannerSettings: { eyebrow: string; classSpacingBody: string; classSpacingOptions: { clustered: string; separated: string; }; classSpacingTitle: string; importanceLabel: string; lighterDayBody: string; lighterDayTitle: string; noPreference: string; preferencesBody: string; preferencesTitle: string; resetBody: string; resetButton: string; resetConfirm: string; availableSubjectBadge: string; scheduleBody: string; scheduleEmpty: string; scheduleLoadError: string; scheduleLoading: string; scheduleTitle: string; selectedClassesEmpty: string; selectedClassesTitle: string; selectedSubjectBadge: string; sameTheoryLabGroupBody: string; sameTheoryLabGroupTitle: string; subjectsBody: string; subjectsDefaultTitle: string; subjectsEmpty: string; subjectsSelectedTitle: string; subjectsSearch: string; subjectsTitle: string; swipeBody: string; swipeTitle: string; teacherRankingBody: string; teacherRankingTitle: string; timeRangeBody: string; timeRangeEndLabel: string; timeRangeStartLabel: string; timeRangeTitle: string; title: string; }; plannerPage: { filteredSubjectsBody: string; filteredSubjectsEmpty: string; filteredSubjectsTitle: string; quickActionsTitle: string; }; searchPage: { empty: string; eyebrow: string; inputLabel: string; inputPlaceholder: string; title: string; }; registrationPage: { body: string; sourceLabels: { destination: string; services: string; }; steps: string[]; title: string; traceability: string; }; mapPage: { body: string; title: string; }; } {
